...
public class CartRestController {
    ...
    @DeleteMapping("/carts/update")
    public ResponseEntity<?> delete(@RequestBody @Valid CartRequest.DeleteDTO requestDTO, Errors errors, @AuthenticationPrincipal CustomUserDetails userDetails) {
        CartResponse.DeleteDTO responseDTO = cartListService.delete(requestDTO, userDetails.getUser());
        ApiUtils.ApiResult<?> apiResult = ApiUtils.success(responseDTO);
        return ResponseEntity.ok(apiResult);
    }
